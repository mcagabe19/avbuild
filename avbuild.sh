...
config1(){
  ...
  local CONFIGURE="configure --extra-version=avbuild --disable-doc ${DEBUG_OPT} $LIB_OPT --extra-ldexeflags="-pie" --enable-static --enable-runtime-cpudetect $FEATURE_OPT $TOOLCHAIN_OPT $USER_OPT"
  : ${NO_ENC=false}
